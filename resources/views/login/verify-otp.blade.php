...
<head>
    ...
    <title>Verify OTP | Rem's Transport</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .resend-btn:disabled {
            opacity: 0.4;
            cursor: not-allowed;
            pointer-events: none; /* Prevents clicks while locked */
        }
...
<div class="card">
    ...
    <i class="fas fa-shield-alt" style="font-size: 30px; color: #2563eb; margin-top: 10px;"></i>
    <h2>Verify OTP</h2>
    <p>We sent a 6-digit verification code to your email. Please enter it below.</p>
